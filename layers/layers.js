...
lyr_Vegetacin_2.set('fieldAliases', {'Especie de Vegetación': 'Especie de Vegetación', });
lyr_Vegetacin_2.set('fieldImages', {'Especie de Vegetación': '', });
lyr_Vegetacin_2.set('fieldLabels', {'Especie de Vegetación': 'no label', });
